      ...
      <div className="legal-page-wrapper">
        <article className="legal-page">
          ...
          <div className="legal-page__content">
            <p>
              At Gooner Technologies, security and compliance are at the core of our enterprise FP&A solutions. We understand that financial data is highly sensitive, and we employ rigorous standards to ensure your data remains protected at all times.
            </p>

            <h2>1. Data Encryption & Storage</h2>
            <p>
              All data processed by Gooner Technologies is encrypted both in transit and at rest.
            </p>
            <ul>
            ...
            <p>
              If you have specific compliance requirements or wish to request our latest SOC 2 report, please reach out to our security team at: <a href="mailto:contact@gooner-tech.com">contact@gooner-tech.com</a>.
            </p>
          </div>
        </article>
      </div>
